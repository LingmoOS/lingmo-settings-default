...
> This repo is aimed to replace the old [deepin-default-settings](https://github.com/linuxdeepin/default-settings) and [velora-desktop-schemas](https://github.com/linuxdeepin/velora-desktop-schemas), since these two repos are all managing system-wide deepin settings, their functionality have overlapped. See [discussion](https://github.com/orgs/linuxdeepin/discussions/11769).
